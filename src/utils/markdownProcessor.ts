...
export type Block = 
  ...
  | 'code' | 'code_pre'
  | 'p' | 'hr' | 'blockquote'
  | 'blockquote_note' | 'blockquote_tip' | 'blockquote_important'
  | 'blockquote_warning' | 'blockquote_caution'
  | 'blockquote_p' | 'blockquote_p_note' | 'blockquote_p_tip'
  | 'blockquote_p_important' | 'blockquote_p_warning' | 'blockquote_p_caution'
  | 'blockquote_title' | 'blockquote_title_note' | 'blockquote_title_tip'
  | 'blockquote_title_important' | 'blockquote_title_warning' | 'blockquote_title_caution'
  | 'image' | 'ul' | 'ol';

export type Inline = 'strong' | 'codespan' | 'link' | 'wx_link' | 'listitem';
